...
/// <summary>
/// Read-model DTO returned by all vendor endpoints.
/// Mirrors <see cref="Business.Domain.Vendor"/> + <see cref="Business.Domain.BusinessPartyBase"/>
/// fields without exposing EF navigation properties.
/// </summary>
